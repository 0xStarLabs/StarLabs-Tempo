...
<head>
    ...
    <title>StarLabs Tempo Configuration</title>
    ...
    <div class="app-container">
        <header>
            <div class="logo">
                ...
                <h1>StarLabs Tempo Configuration</h1>
            </div>
        ...
        <main>
            <div class="sidebar">
                <div class="sidebar-menu">
                    ...
                    <div class="sidebar-item" data-section="token_sender">
                        <i class="fas fa-paper-plane"></i>
                        <span>Token Sender</span>
                    </div>
...
function renderConfig(config) {
    ...
    const sections = {
        ...
        'token_sender': { key: 'TOKEN_SENDER', title: 'Token Sender', icon: 'paper-plane' },
    ...
    Object.entries(sections).forEach(([sectionId, { key, title, icon }], index) => {
        ...
        if (config[key]) {
            if (key === 'SETTINGS') {
                ...
                createCard(cardsContainer, 'Telegram Settings', 'telegram', [
...
function createRangeField(container, key, value, path) {
    ...
    const isFloatField = path.includes('PERCENT_OF_BALANCE_TO_SEND');
